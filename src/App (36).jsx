    ...
    <div style={{ fontFamily: BF, background: A.bg, minHeight: "100vh", maxWidth: 560, margin: "0 auto", color: A.text }}>
      ...
      <div style={{ padding: "24px 20px" }}>
        <div style={{ background: A.card, borderRadius: 14, padding: 20, border: `1px solid ${A.border}`, marginBottom: 16 }}>
          ...
          <div style={{ background: A.card2, borderRadius: 12, padding: "14px", marginBottom: 16, border: `1px solid ${expiry ? A.green + "44" : A.border}` }}>
            <div style={{ fontFamily: BF, fontSize: 11, color: expiry ? A.green : A.muted, letterSpacing: 2, textTransform: "uppercase", marginBottom: 8 }}>{expiry ? "✓ Caducidad introducida" : "Caducidad del pasaporte"}</div>
