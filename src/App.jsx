      ...
      <div style={{ padding:"0 16px" }}>
        ...
        {passModal && (
          <div style={{ position:"fixed",top:0,left:0,right:0,bottom:0,zIndex:9999,background:"#000",display:"flex",flexDirection:"column",overflowY:"auto" }}>
            ...
            {/* FULL IMAGE — contain, nothing cropped */}
            <div style={{ background:"#000",display:"flex",alignItems:"center",justifyContent:"center",padding:"12px",flexShrink:0 }}>
              <img src={passModal.src}
                style={{ maxWidth:"100%",maxHeight:"55vh",objectFit:"contain",borderRadius:8,boxShadow:"0 0 40px rgba(0,200,255,0.15)" }}
                alt="Pasaporte" />
            </div>
