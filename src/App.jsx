                ...
                <div style={{ display:"flex",gap:12,padding:"12px" }}>
                  ...
                  <div style={{ flex:1,minWidth:0 }}>
                    ...
                    <input
                      ...
                      style={{ ...ais,colorScheme:"dark",textAlign:"center",fontFamily:ANTON,fontSize:14,color:passportWarn(c.passportExpiry)?A.orange:A.text,background:A.card,border:`1px solid ${passportWarn(c.passportExpiry)?A.orange+"44":A.border+"44"}` }}
                    />
                  </div>
                </div>
