    ...
    files.forEach(f => {
      ...
      r.onload = ev => {
        ...
        img.onload = () => {
          ...
          setPhotos(prev => [...prev, canvas.toDataURL("image/jpeg", 0.88)]);
        };
    ...
    <div style={{ fontFamily: BF, background: A.bg, minHeight: "100vh", maxWidth: 560, margin: "0 auto", color: A.text }}>
      ...
      <div style={{ padding: "24px 20px" }}>
        <div style={{ background: A.card, borderRadius: 14, padding: 20, border: `1px solid ${A.border}`, marginBottom: 16 }}>
          ...
          <input ref={ref} type="file" accept="image/jpeg,image/png,image/webp,image/gif,image/heic,image/heif,image/*" multiple style={{ display: "none" }} onChange={onFile} />
