              ...
              <div style={{ marginTop:10,background:c.docVerified?A.green+"0e":A.bg,borderRadius:12,border:`2px solid ${c.docVerified?A.green+"55":c.docNumero?A.cyan+"44":A.border+"33"}`,overflow:"hidden" }}>
                ...
                <div style={{ display:"flex",gap:12,padding:"12px" }}>
                  ...
                  <div style={{ flex:1,minWidth:0 }}>
                    ...
                    <input
                      value={c.docNumero||""}
                      onChange={e=>updClient(c.id,x=>({...x,docNumero:e.target.value.toUpperCase(),docVerified:false}))}
                      placeholder="—"
                      style={{ ...ais,fontFamily:ANTON,fontSize:c.docNumero&&c.docNumero.length<=10?26:20,letterSpacing:4,textAlign:"center",color:A.cyan,padding:"8px 10px",marginBottom:8,background:A.card }}
                    />
                    <div style={{ fontFamily:BF,fontSize:9,color:A.muted,letterSpacing:2,textTransform:"uppercase",marginBottom:4 }}>Caducidad</div>
                    <div style={{ fontFamily:ANTON,fontSize:16,color:passportWarn(c.passportExpiry)?A.orange:A.text,letterSpacing:2,textAlign:"center",background:A.card,borderRadius:8,padding:"6px 10px",border:`1px solid ${passportWarn(c.passportExpiry)?A.orange+"44":A.border+"44"}` }}>
                      {c.passportExpiry ? new Date(c.passportExpiry+"T12:00:00").toLocaleDateString("es-ES",{day:"2-digit",month:"2-digit",year:"numeric"}) : "—"}
                    </div>
                  </div>
                </div>
